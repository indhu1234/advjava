...
public class UserRegisterDAO {
	...
	//	Class.forName("com.mysql.jdbc.Driver");
		...
		//Connection con = DriverManager.getConnection("jdbc:mysql://localhost/strutsdb", "root", "ROOT");
		Connection con = DriverManager.getConnection("jdbc:h2:tcp://localhost/~/structsdb","sa","sa");
